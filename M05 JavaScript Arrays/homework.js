...
function promedioResultadosTest(resultadosTest) {
   ...
   for (let i = 0; i < resultadosTest.length; i++) {
      ...
      var promedioNotas = sumaNumeros/resultadosTest.length;
   }
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numeroMasElevado = arrayOfNums[0];
   for (let i= 1; i < arrayOfNums.length; i++) {
      if(arrayOfNums[i] > numeroMasElevado) {
         numeroMasElevado = arrayOfNums[i]
      }
   }
   return numeroMasElevado
}
